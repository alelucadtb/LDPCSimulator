...
int main() {
    ...
    //std::vector<std::pair<double, int> > numberOfCodeword = {{0.1, 10000}, {0.2, 10000}, {0.3, 10000}, {0.4, 10000}, {0.5, 10000}, {0.6, 5000}, {0.7, 1000}, {0.8, 1000}, {1.0, 100}, {1.1, 100}, {1.2, 10}, {1.3, 10}, {1.4, 10}, {1.5, 10}, {2, 10}, {2.5, 10}, {3, 10}, {3.5, 10}};
    ...
    std::vector<std::pair<double, int> > numberOfCodeword = {{0.7, 1}};
